...
#define USB_SFP_VID 0x04d9
#define USB_SFP_PID 0xa055
...
class HWModel_holtek_kbd : public HWModel {
public:
  HWModel_holtek_kbd()
      : HWModel("holtek_kbd", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_holtek_kbd(){};
