...
class HWModel_gma500 : public HWModel {
public:
  HWModel_gma500()
      : HWModel("gma500", 0x8086, 0x8108), probe_len(0) {
...
Stage2HWModel *new_stage2_model_gma500() {
